...
Future<Locale> setLocale(String languageCode) async {
  SharedPreferenceHelper.setString(ConstString.currentLanguageCode, languageCode);
...
Future<Locale> getLocale() async {
  String languageCode = SharedPreferenceHelper.getString(ConstString.currentLanguageCode);
  return _locale(languageCode);
}
